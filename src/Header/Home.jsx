...
function Home() {
 // const { user, isLoggedIn } = useContext(AuthContext); // Access authentication state from context
     ...
     
{
  ...
  <div className="card-body">
    ...
    <div>
      ...
      {/* Conditional rendering of "Buy Now" button
      {isLoggedIn && (
      ...
      {!isLoggedIn && (
        <p>
          Please <Link to="/login">login</Link> or <Link to="/register">register</Link> to buy!
        </p>
      )} */}
    </div>
